...
public class MercadoPagoController {
    ...
    public ResponseEntity<String> getList(@RequestBody UserBuyerDTO userBuyer) {
        if(userBuyer == null) {throw new IllegalArgumentException("UserBuyer is required");}
        ...
        }catch(MPException | MPApiException e) { System.out.println(e); return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error al crear la preferencia");
